...
void CInstallDlg::OnCheckout() 
{
	...
	for (i=0; i<count; i++)
	{
		...
		Log::Logger("CheckM25 b4 calling m25 the adCmdText is " + adCmdText);
...
BOOL CInstallDlg::CheckM25(CString meter_no)
{
	...
	try
	{
		...
		Log::Logger("CheckM25 the biaoleixing is " + biaoleixing);
	...
	else
	{
		...
		Log::Logger("CheckM25 the adCmdText is " + adCmdText);
